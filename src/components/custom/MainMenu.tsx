...
const MainMenu = (props: Props) => {
  ...
  const playoffs = process.env.NEXT_PUBLIC_PLAYOFFS === 'true' ? true : false

  return (
    <article id="main-menu" className=" min-w-[350px] lg:max-w-screen-xl md:mx-auto pt-12 lg:pt-12 mb-24 lg:mb-0" >
      <h1 className="text-grad mx-auto w-max text-center text-5xl md:text-7xl text-shadow uppercase mt-20 lg:mt-24">Main Menu</h1>
