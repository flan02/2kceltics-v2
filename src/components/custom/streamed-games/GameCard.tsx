        ...
        !video_url
          ...
          video_url.length != 0
                ...
                <div className={`relative border border-slate-300 rounded-xl hover:bg-slate-200/50 hover:border hover:border-slate-900`} key={index}>
                  ...
                  <div className={`px-4 pb-4 pt-2 flex justify-between ${game.stage == "CUP_GP" ? "bg-orange-200/40 dark:bg-night-70" : ""} ${game.type == "PO" ? "dark:bg-[#241825] bg-[#d9e6da]" : ""}`}>
                    ...
                    <div className='flex flex-col justify-end'>
                      ...
                      <Button className='text-xs px-1 self-end dark:bg-midnight dark:hover:bg-midnight/80 dark:hover:border border dark:text-green-50' asChild>
            ...
            <div className='col-span-3 place-content-center text-center h-[450px]' >
              <h2 className='uppercase text-midnight dark:text-zinc-700 text-4xl'>No games found.</h2>
            </div>
      }
