...
const About = (props: Props) => {
  return (
    <section className="max-w-screen-xl mx-auto pt-12">
      <h1 className="text-celtics mx-auto w-max text-center text-7xl text-shadow uppercase mt-24">Our Mission</h1>
      <article className='max-w-screen-lg mt-16 h-max mx-auto'>
        <h3 className='text-celtics text-shadow text-lg'>
        ...
        <div className='flex mt-8 items-center justify-end'>
          ...
          <h6 className='text-muted-foreground text-md ml-4'>
            Best regards, <br />
            Dan Chanivet. <br />
