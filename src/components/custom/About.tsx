...
const About = (props: Props) => {
  return (
    <section className="max-w-screen-xl mx-auto pt-12 lg:pb-0 lg:pt-12">
      <h1 className="text-celtics mx-auto w-max text-center text-5xl lg:text-7xl text-shadow uppercase mt-24">Our Mission</h1>
      <article className='max-w-screen-lg mt-16 h-max mx-auto px-3 md:px-0'>
        <h3 className='text-celtics text-shadow text-base md:text-lg'>
