  ...
  return (
    <section id="roster" className="max-w-screen-xl flex flex-col mx-auto pt-4 lg:pt-12">
      <div className="flex mx-auto mb-2 lg:mb-12">
        <h1 className="text-grad mx-auto w-max text-center text-4xl sm:text-5xl md:text-7xl text-shadow uppercase mt-24">2025/26 ROSTER</h1>
        <BackToTop />
      </div>
      <br />
      <br />

      <Card className="md:flex md:justify-center mx-1.5 border-none py-4 block md:py-0 dark:bg-night-80/60 bg-white/20">
